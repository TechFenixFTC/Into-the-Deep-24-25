...
public class RotaCompletaSample0MAIS4 {
            public static void main(String[] args) {
                ...
                RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                        ...
                        .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-35, -62, Math.toRadians(0)))
                                //todo: DEPOSIT
                                ...
                                .splineToLinearHeading(new Pose2d(-30, -10, Math.toRadians(0)), Math.toRadians(45))
