...
@Disabled
@TeleOp(name="TeleoperadoDemonstra")
@Config
public class TeleoperadoDemonstracao extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("estadoManual",SubsistemasSuperiores.bracoModoManual);
