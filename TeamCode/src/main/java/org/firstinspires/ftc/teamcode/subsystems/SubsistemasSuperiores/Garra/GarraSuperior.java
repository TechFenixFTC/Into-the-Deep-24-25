...
public class GarraSuperior extends Garra {
    ...
    public static double positionTransfer  = 0.6127777777777779 ,getPositionTransferRotacion =0.6888;
    double delay = 0.3;
    ...
    public GarraSuperior(HardwareMap hardwareMap) {
        ...
        mapOpening.put(GarraOpeningStates.OPEN, 0.329);//todo okey
        mapOpening.put(GarraOpeningStates.CLOSED, 1.0);//todo okey
        mapOpening.put(GarraOpeningStates.HALF, 0.501);// transfer
