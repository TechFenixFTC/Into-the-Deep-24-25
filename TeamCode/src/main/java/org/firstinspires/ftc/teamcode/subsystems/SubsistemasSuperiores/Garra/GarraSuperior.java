...
public class GarraSuperior extends Garra {
    ...
    public GarraSuperior(HardwareMap hardwareMap) {
        ...
        mapAngulation.put(GarraAngulationStates.OUTTAKE_SPECIMEN,  0.5627777777777778);//todo okey
        ...
        mapRotation.put(GarraSuperiorRotetionStates.CHAMBER, 0.678);//todo okey
