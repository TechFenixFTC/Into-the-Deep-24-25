...
public class LimelightTest3 extends OpMode {
    ...
    public void loop() {
        ...
        if (result != null){
    List<LLResultTypes.FiducialResult> fiducials = result.getFiducialResults(); //todo: verificar se vai dar erro nisso dnv
        ...
        telemetry.addData("Fiducial " + id, "está a " + StrafeDistance_3D + " metros de distância");
        telemetry.addData("n sei", fiducial.getRobotPoseTargetSpace());
    }}
