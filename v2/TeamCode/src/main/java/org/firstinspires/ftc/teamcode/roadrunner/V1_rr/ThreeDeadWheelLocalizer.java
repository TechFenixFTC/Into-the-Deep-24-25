package org.firstinspires.ftc.teamcode.roadrunner.V1_rr;
...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2819.843601280494; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2335.8200496726295; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2020.2688152810945; // x position of the perpendicular encoder (in tick units)
    }
