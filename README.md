...
This repository contains the can use the "Download Zip" button available through the main repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.
  public FTC SDK for the INTO THE DEEP (2024-2025) competition season.
...
&nbsp;&nbsp;&nbsp;[FtcRobotController](FtcRobotController)&nbsp;&nbsp;&nbsp;[FTC Blocks Online Tutorial](https://ftc-docs.firstinspires.org/programming_resources/blocks/Blocks-Tutorial.html)
